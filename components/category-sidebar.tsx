        ...
        <div className="border-border bg-card rounded-lg border p-6 transition-all duration-300 hover:shadow-md">
          ...
          >
            ...
            <ChevronDown
              ...
              style={{ transform: isFiltersOpen ? "rotate(0deg)" : "rotate(-90deg)" }}
            />
          </button>

          <div
            className={`overflow-hidden transition-all duration-500 ease-in-out ${isFiltersOpen ? "max-h-[800px] opacity-100" : "max-h-0 opacity-0"}`}
          >
